    ...
    <div className="relative mx-auto max-w-screen-xl h-[500px] overflow-hidden rounded-lg shadow-lg mt-4">
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-start p-8 text-white space-y-4">
          ...
          <button className="px-6 py-2 bg-gray-500 text-white font-semibold rounded-lg shadow-lg hover:bg-gray-600 transition-all">
      ...
      {/* Navigation Buttons */}
      <button
        className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white text-black rounded-full p-2 shadow-md hover:scale-105 focus:outline-none focus:ring focus:ring-gray-300"
        onClick={handlePrev}
      >
        &#10094;
      </button>
      <button
        className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white text-black rounded-full p-2 shadow-md hover:scale-105 focus:outline-none focus:ring focus:ring-gray-300"
        onClick={handleNext}
      >
        &#10095;
      </button>
